 ...
 * @param {Object} [access] - Passed to {@link https://github.com/primus/access-control|access-control}.
 * @param {boolean} [config.http2] - Whether to use {@link https://tools.ietf.org/html/rfc7540|HTTP/2} ({@link https://nodejs.org/api/http2.html#http2_http2_createserver_options_onrequesthandler|http2.createServer}/{@link https://nodejs.org/api/http2.html#http2_http2_createsecureserver_options_onrequesthandler|http2.createSecureServer}) instead of HTTP. Note this still uses Server-Sent Events to deliver messages. If you want to use HTTP/2 streams to deliver messages, see the  {@link centro-js/lib/server_transports/http2|http2} and {@link centro-js/lib/server_transports/http2_duplex|http2_duplex} transports. Defaults to `false`.
 */
"use strict";
