 ...
 * @param {Object} config - Configuration options. This supports all the options supported by {@link https://nodejs.org/api/https.html#https_https_createserver_options_requestlistener|https.createServer} and {@link https://github.com/primus/access-control|access-control} as well as the following:
 ...
 * @param {string} [config.pathname] - Pathname prefix on which to listen for requests. Defaults to `/centro/v1/`. Publish requests are made on `/centro/v1/publish` and subscribe requests are made on `/centro/v1/subscribe`.
