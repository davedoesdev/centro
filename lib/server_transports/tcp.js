 ...
 * @param {boolean} [config.noDelay] - If not `undefined`, then it is passed to {@link https://nodejs.org/api/net.html#net_socket_setnodelay_nodelay|setNoDelay} on every connection.
