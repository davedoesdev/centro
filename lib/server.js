...
*** add option to close conn or not to limit_conn extensions

*** we need to be able to add multiple extensions
at the moment, each will subscribe/publish so will be an error
- write a test to show multiple fail
