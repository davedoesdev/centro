// TODO:
// Should sse support multiple subscribe topics - coverage
// what if don't specify topic in http request - or other params?
//   json schema on params?
// do we have enough hooks to support authz timeout?
//   no! have config option which calls authz destroy after timeout
// EventSource for subscriptions - browser example
// should bpmux propagate errors?
//   just have end_with_error method, other end emits error before ending
// maxConnections on tcp, http, https and primus
//   max connections per issuer? can't be done across instances though
