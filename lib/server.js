...
{
    return require('.' + path.sep + path.join('server_transports', name));
};
...
/**
 * Pre-connect event. Emitted after {@link centro-js/lib/server.event:authz_end}
 * but before {@link centro-js/lib/server.event:connect}. The client connection
