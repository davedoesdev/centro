...
backoff should receive function to listen for drain on mux?
or mqlobber should emit drain event
re-emit drain, full and removed too?
...
function CentroServer(config)
{
    ...
    config = Object.assign(
    {
        ...
        max_topic_length: 32 * 1024,               // mqlobber-access-control,
                                                   // centro server
