...
exports.authz_token_schema = function (config, required)
{
	...
	return {
		description: 'Schema for Centro authorization tokens',
		type: 'object',
		required: required,
		properties: {
			exp: {
			...
			access_control: {
				description: 'Which topics clients presenting this token can subscribe and publish to. See https://github.com/davedoesdev/mqlobber-access-control',
				type: 'object',
			...
			ack: {
				description: 'Publish an acknowledgement message when a client presenting this token acknowledges receipt of a message. See https://github.com/davedoesdev/mqlobber#mqlobberservereventsackinfo',
				type: 'object',
				required: ['prefix'],
				additionalProperties: false,
				properties: {
