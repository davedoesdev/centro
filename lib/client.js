...
function start(stream, config)
{
    ...
    mqclient.on('handshake', function (hsdata)
    {
        ...
        if (hsdata.version !== exports.version)
        {
            return this.emit('error', new Error('unsupported version: ' + hsdata.version));
        }
        ...
        this.unsubscribe = function (n, topic, handler, cb)
        {
            ...
            if (topic === undefined)
            {
                async.eachSeries(this._subs, function (th, cb)
                {
