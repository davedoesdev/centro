...
If you're not using Javascript, you can use the HTTP transport. As long as you
can make POST requests, you can publish messages. To subscribe to messages,
you'll need to be able to receive server-sent events.
